...
public class App{
    ...
    public App(String nama, String nim, String jurusan, String jenisKelamin, int tahunLahir) {
        this.nama = nama;
        this.nim = nim;
    ...
    public static void main(String[] args) {
        ...
        ArrayList<App> mahasiswa = new ArrayList<App>();
        ...
        for (int i = 0; i < jumlahMahasiswa; i++) {
            ...
            App m= new App(nama, nim, jurusan, jenisKelamin, tahunLahir);
            mahasiswa.add(m);
        }
